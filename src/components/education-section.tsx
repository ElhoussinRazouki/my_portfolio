...
const getCertPdf = (cert: string) => {
  const map: Record<string, string> = {
    ...
    "PCAP: Programming Essentials In Python":
      "/certificates/programming-essentials.pdf",
  };
  return map[cert];
};
...
const EducationSection = () => {
  ...
  const handleCertClick = (certName: string, certLink: string | undefined) => {
    trackDownload(certName, "certificate");
    if (certLink) {
      trackLinkClick(certLink, certName, true);
    }
  };
  ...
  return (
    <section
      ...
      onMouseEnter={() => trackSectionView("education")}
    >
